...
public class Ticket {
    ...
    public Ticket(FullName fullName, String visitingReason, ArrayList<Doctor> doctors, GregorianCalendar visitingDate) {
    ...
    public String toString() {
        ...
        for (Doctor doctor: doctors) {
            doctorsString.append(doctor.getType()).append(", ");
        }
